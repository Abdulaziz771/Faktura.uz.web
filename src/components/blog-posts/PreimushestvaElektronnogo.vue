                    ...
                    <div class="col-12">
                        <div class="post-body">
                            <div class="update-text">
                                ...
                                <div></div>
                                <img src="../../assets/img/blog/Preimushestva Elektronnogo/preimushestva-content-in.jpg" alt="">
                                <p>
...
export default {
    ...
    metaInfo() {
        return { 
            title: "Предупреждение об использовании временных кодов",
            meta: [
                { name: 'description', content:  'Предупреждение об использовании временных кодов'},
            ]
        }
    },
    methods: {
